...
part 'widget_folder_model.gen.g.dart';
...
class WidgetFolderModel extends TravelItemModel implements WidgetFolderEntity {
  ...
  /// Creates a [WidgetFolderModel] from a JSON.
  factory WidgetFolderModel.fromJson(Json json) =>
      _$WidgetFolderModelFromJson(json);

  /// Converts the [WidgetFolderModel] to a JSON.
  Json toJson() => _$WidgetFolderModelToJson(this);
